...
(assert (! true :named CON_63))
(assert (! (= x_1_0 0 ) :named PS_2))
(assert (! (= x_1_1 0 ) :named PS_3))
(assert (! (=> (< (+ (- 4) x_1_1 ) 0 ) (= x_2_0 1539701000 ) ) :named PS_4))
...
(assert (! (= x_10_0 6470692 ) :named PS_18))
(assert (! (= x_11_0 0 ) :named PS_19))
(assert (! (= x_11_1 2 ) :named PS_20))
(assert (! (= x_12_0 (- 823702027) ) :named PS_21))
(assert (! (=> (= (+ (- 2) x_11_1 ) 0 ) (= x_12_1 0 ) ) :named PS_22))
(assert (! (=> (and (< (+ (- 9) x_12_1 ) 0 ) (= (+ (- 2) x_11_1 ) 0 ) ) (= x_13_0 0 ) ) :named PS_23))
...
(assert (! (=> (and (< (+ (- 9) x_12_1 ) 0 ) (= (+ (- 2) x_11_1 ) 0 ) ) (distinct (+ (- 4390) x_13_2 ) 0 ) ) :named PS_27))
(assert (! (=> (= (+ (- 2) x_11_1 ) 0 ) (= x_12_2 (+ 1 x_12_1 ) ) ) :named PS_28))
(assert (! (=> (and (< (+ (- 9) x_12_2 ) 0 ) (= (+ (- 2) x_11_1 ) 0 ) ) (= x_14_0 10 ) ) :named PS_29))
...
(assert (! (= x_15_0 6470696 ) :named PS_35))
(assert (! (= x_16_0 0 ) :named PS_36))
(assert (! (= x_16_1 1 ) :named PS_37))
(assert (! (= x_17_0 (- 823702027) ) :named PS_38))
(assert (! (=> (= (+ (- 1) x_16_1 ) 0 ) (= x_17_1 0 ) ) :named PS_39))
(assert (! (=> (and (< (+ (- 9) x_17_1 ) 0 ) (= (+ (- 1) x_16_1 ) 0 ) ) (= x_18_0 11065 ) ) :named PS_40))
...
(assert (! (=> (and (< (+ (- 9) x_17_1 ) 0 ) (= (+ (- 1) x_16_1 ) 0 ) ) (distinct (+ (- 24) x_18_2 ) 0 ) ) :named PS_44))
(assert (! (=> (= (+ (- 1) x_16_1 ) 0 ) (= x_17_2 (+ 1 x_17_1 ) ) ) :named PS_45))
(assert (! (=> (and (< (+ (- 9) x_17_2 ) 0 ) (= (+ (- 1) x_16_1 ) 0 ) ) (= x_19_0 21 ) ) :named PS_46))
...
(assert (! (=> (and (< (+ (- 9) x_17_2 ) 0 ) (= (+ (- 1) x_16_1 ) 0 ) ) (distinct (+ (- 24) x_19_2 ) 0 ) ) :named PS_50))
(assert (! (=> (= (+ (- 1) x_16_1 ) 0 ) (= x_17_3 (+ 1 x_17_2 ) ) ) :named PS_51))
(assert (! (=> (and (< (+ (- 9) x_17_3 ) 0 ) (= (+ (- 1) x_16_1 ) 0 ) ) (= x_20_0 22 ) ) :named PS_52))
...
(assert (! (=> (and (< (+ (- 9) x_17_3 ) 0 ) (= (+ (- 1) x_16_1 ) 0 ) ) (distinct (+ (- 24) x_20_2 ) 0 ) ) :named PS_56))
(assert (! (=> (= (+ (- 1) x_16_1 ) 0 ) (= x_17_4 (+ 1 x_17_3 ) ) ) :named PS_57))
(assert (! (=> (and (< (+ (- 9) x_17_4 ) 0 ) (= (+ (- 1) x_16_1 ) 0 ) ) (= x_21_0 23 ) ) :named PS_58))
(assert (! (=> (and (< (+ (- 9) x_17_4 ) 0 ) (= (+ (- 1) x_16_1 ) 0 ) ) (= x_21_1 x_0_5 ) ) :named PS_59))
(assert (! (=> (and (< (+ (- 9) x_17_4 ) 0 ) (= (+ (- 1) x_16_1 ) 0 ) ) (= x_21_2 (+ 1 x_21_1 ) ) ) :named PS_60))
(assert (! (=> (and (< (+ (- 9) x_17_4 ) 0 ) (= (+ (- 1) x_16_1 ) 0 ) ) (= x_0_6 x_21_2 ) ) :named PS_61))
